# 3 link robot 
#for basis function 'x'
#changed gamma is 60 degrees 
...
plt.savefig('C:/Users/rheap/Documents/CMU/BioRobotics lab/results/3_link_x_a1plot')
plt.show()

#a2 plot
fig2=plt.figure()
plt.plot(deltax3plot,a2_plot)
plt.savefig('C:/Users/rheap/Documents/CMU/BioRobotics lab/results/3_link_x_a2plot')
plt.show()

#a3 plot
fig3=plt.figure()
plt.plot(deltax3plot,a3_plot)
plt.savefig('C:/Users/rheap/Documents/CMU/BioRobotics lab/results/3_link_x_a3plot')
plt.show()
