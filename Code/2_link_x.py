...
plt.savefig('C:/Users/rheap/Documents/CMU/BioRobotics lab/results/2_link_x_a1plot')
plt.show()

fig2=plt.figure()
plt.plot(deltax2plot,a2_plot)
plt.savefig('C:/Users/rheap/Documents/CMU/BioRobotics lab/results/2_link_x_a2plot')
plt.show()
